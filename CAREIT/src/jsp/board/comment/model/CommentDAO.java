...
import jsp.board.comment.action.CommentBean;
...
public class CommentDAO 
{
    ...
    public boolean insertComment(CommentBean comment)
    {
        ...
        try {
            ...
            StringBuffer sql = new StringBuffer();
            sql.append("INSERT INTO REVIEWINFO");
            sql.append(" (REVIEWNO,  USRENO, REVIEWDATE");
            sql.append(" ,  REVIEWCONTENTS)");
...
출처: https://all-record.tistory.com/143 [세상의 모든 기록]